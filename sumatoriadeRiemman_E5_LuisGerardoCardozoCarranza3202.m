...
% Sumatoria de Riemann_supeiores_e_inferiores Ejercicio 5 f(x)=3(1/3)x^2;[-3,3]
% Si se graficá su comportamiento es cuadratico.
  
  %suma de riemann para calcular el area debajo de la curva de f(x)=3(1/3)x^2;[-3,3]
%Limpiar variables.
  clean; clc;
%intervalo
  a=-3; b=3;
